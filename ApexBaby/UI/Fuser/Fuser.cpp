...
bool Fuser::Initialize(ImVec2 window_size, bool SDF)
{
	...
	wc.hbrBackground = 0;
	wc.lpszClassName = xorstr_(L"Arma IV");
	...
	m_hwnd = ::CreateWindowEx(NULL, xorstr_(L"Arma IV"), xorstr_(L"Arma IV"), WS_POPUP | WS_VISIBLE, 0, 0, window_size.x, window_size.y, nullptr, nullptr, wc.hInstance, nullptr);
