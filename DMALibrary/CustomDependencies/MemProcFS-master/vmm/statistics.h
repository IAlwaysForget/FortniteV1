...
typedef enum tdSTATISTICS_ID
{
	...
	STATISTICS_ID_MmPfn_Map_GetPfnSystem,
	STATISTICS_ID_VMMDLL_ProcessGet,
...
static LPCSTR STATISTICS_ID_STR[STATISTICS_ID_MAX] = {
	...
	[STATISTICS_ID_MmPfn_Map_GetPfnSystem] = "VMMDLL_Map_GetSystemPfn",
	[STATISTICS_ID_VMMDLL_ProcessGet] = "VMMDLL_ProcessGet",
